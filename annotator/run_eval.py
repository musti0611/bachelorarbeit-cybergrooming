"""
Evaluate GPT-4o-mini annotator against the manual gold standard.
...
from annotator_gpt import annotate, MODEL
...
N_FEWSHOT = 3
PROMPT_VERSION = "v2"  # v1: baseline | v2: improved VERTRAUENSAUFBAU + KONTROLLE/NOETIGUNG rules
