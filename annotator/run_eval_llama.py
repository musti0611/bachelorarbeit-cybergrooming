"""Evaluate Llama 3.3 70B (via Groq) annotator against the manual gold standard."""
...
from annotator_llama import annotate, MODEL
...
def main():
    ...
    print(f"\nRunning {MODEL} (Groq) on {total} examples...\n")
    ...
    print(f"\n{'='*60}")
    print(f"EVALUATION RESULTS -- {MODEL} (Groq)")
    print(f"{'='*60}\n")
